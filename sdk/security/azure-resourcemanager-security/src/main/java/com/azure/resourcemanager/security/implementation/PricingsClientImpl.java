...
public final class PricingsClientImpl implements PricingsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PricingListAutoGeneratedInner>> listWithResponseAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PricingListAutoGeneratedInner>> listWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PricingListAutoGeneratedInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PricingListAutoGeneratedInner> listWithResponse(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PricingListAutoGeneratedInner list() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PricingAutoGeneratedInner>> getWithResponseAsync(String pricingName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PricingAutoGeneratedInner>> getWithResponseAsync(String pricingName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PricingAutoGeneratedInner> getAsync(String pricingName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PricingAutoGeneratedInner> getWithResponse(String pricingName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PricingAutoGeneratedInner get(String pricingName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PricingAutoGeneratedInner>> updateWithResponseAsync(String pricingName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PricingAutoGeneratedInner> updateAsync(String pricingName, PricingAutoGeneratedInner pricing) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PricingAutoGeneratedInner> updateWithResponse(String pricingName, PricingAutoGeneratedInner pricing,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PricingAutoGeneratedInner update(String pricingName, PricingAutoGeneratedInner pricing) {
