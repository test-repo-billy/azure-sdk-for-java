...
public interface PricingsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PricingListAutoGeneratedInner> listWithResponse(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PricingListAutoGeneratedInner list();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PricingAutoGeneratedInner> getWithResponse(String pricingName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PricingAutoGeneratedInner get(String pricingName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PricingAutoGeneratedInner> updateWithResponse(String pricingName, PricingAutoGeneratedInner pricing,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PricingAutoGeneratedInner update(String pricingName, PricingAutoGeneratedInner pricing);
}
