...
public final class PricingsImpl implements Pricings {
    ...
    public Response<PricingListAutoGenerated> listWithResponse(Context context) {
        Response<PricingListAutoGeneratedInner> inner = this.serviceClient().listWithResponse(context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public PricingListAutoGenerated list() {
        PricingListAutoGeneratedInner inner = this.serviceClient().list();
        if (inner != null) {
    ...
    public Response<PricingAutoGenerated> getWithResponse(String pricingName, Context context) {
        Response<PricingAutoGeneratedInner> inner = this.serviceClient().getWithResponse(pricingName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public PricingAutoGenerated get(String pricingName) {
        PricingAutoGeneratedInner inner = this.serviceClient().get(pricingName);
        if (inner != null) {
    ...
    public Response<PricingAutoGenerated> updateWithResponse(String pricingName, PricingAutoGeneratedInner pricing,
        Context context) {
        Response<PricingAutoGeneratedInner> inner
            = this.serviceClient().updateWithResponse(pricingName, pricing, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new PricingAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public PricingAutoGenerated update(String pricingName, PricingAutoGeneratedInner pricing) {
        PricingAutoGeneratedInner inner = this.serviceClient().update(pricingName, pricing);
        if (inner != null) {
            return new PricingAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
