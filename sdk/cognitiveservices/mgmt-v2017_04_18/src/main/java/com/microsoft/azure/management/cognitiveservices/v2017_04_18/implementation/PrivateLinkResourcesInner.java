...
public class PrivateLinkResourcesInner {
    ...
    private ServiceResponse<PrivateLinkResourceListResultInner> listDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
