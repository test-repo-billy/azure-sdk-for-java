...
public class OperationsInner {
     ...
     */
    public OperationsInner(Retrofit retrofit, CognitiveServicesManagementClientImpl client) {
    ...
    interface OperationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v2017_04_18.Operations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v2017_04_18.Operations listNext" })
        @GET
    ...
    private ServiceResponse<PageImpl<OperationEntityInner>> listDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<OperationEntityInner>, CloudException>newInstance(this.client.serializerAdapter())
    ...
    private ServiceResponse<PageImpl<OperationEntityInner>> listNextDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<OperationEntityInner>, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<OperationEntityInner>>() { }.getType())
                .registerError(CloudException.class)
                .build(response);
