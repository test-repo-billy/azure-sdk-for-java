...
import com.microsoft.azure.management.applicationinsights.v2015_05_01.ErrorResponseException;
...
public class OperationsInner {
     ...
     */
    public OperationsInner(Retrofit retrofit, ApplicationInsightsManagementClientImpl client) {
    ...
    interface OperationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.applicationinsights.v2015_05_01.Operations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.applicationinsights.v2015_05_01.Operations listNext" })
        @GET
