...
public final class WorkbookImpl implements Workbook, Workbook.Definition, Workbook.Update {
    ...
    public Workbook create() {
        this.innerObject = serviceManager.serviceClient().getWorkbooks().createOrUpdateWithResponse(resourceGroupName,
            resourceName, this.innerModel(), createSourceId, Context.NONE).getValue();
        return this;
    }
    ...
    public Workbook apply() {
        this.innerObject = serviceManager.serviceClient().getWorkbooks().updateWithResponse(resourceGroupName,
            resourceName, updateSourceId, updateWorkbookUpdateParameters, Context.NONE).getValue();
        return this;
    }

    public Workbook apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getWorkbooks().updateWithResponse(resourceGroupName,
            resourceName, updateSourceId, updateWorkbookUpdateParameters, context).getValue();
        return this;
    }
    ...
    public Workbook refresh(Context context) {
        Boolean localCanFetchContent = null;
        this.innerObject = serviceManager.serviceClient().getWorkbooks()
            .getByResourceGroupWithResponse(resourceGroupName, resourceName, localCanFetchContent, context).getValue();
        return this;
    }
