...
public class StorageAccountCreateParameters {
    ...
    /**
     * Get optional. Set the extended location of the resource. If not set, the storage account will be created in Azure main region. Otherwise it will be created in the specified extended location.
     *
    ...
    /**
     * Set optional. Set the extended location of the resource. If not set, the storage account will be created in Azure main region. Otherwise it will be created in the specified extended location.
     *
    ...
    /**
     * Get nFS 3.0 protocol support enabled if sets to true.
     *
    ...
    /**
     * Set nFS 3.0 protocol support enabled if sets to true.
     *
     * @param isNfsV3Enabled the isNfsV3Enabled value to set
     * @return the StorageAccountCreateParameters object itself.
     */
    public StorageAccountCreateParameters withIsNfsV3Enabled(Boolean isNfsV3Enabled) {
