...
public class OrganizationOperationsInner {
    ...
    private ServiceResponse<PageImpl<OperationResultInner>> listDelegate(Response<ResponseBody> response) throws ResourceProviderDefaultErrorResponseException, IOException {
