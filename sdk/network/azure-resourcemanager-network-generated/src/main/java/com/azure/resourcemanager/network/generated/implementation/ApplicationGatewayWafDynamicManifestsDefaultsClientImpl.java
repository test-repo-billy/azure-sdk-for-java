...
public final class ApplicationGatewayWafDynamicManifestsDefaultsClientImpl
    ...
    public interface ApplicationGatewayWafDynamicManifestsDefaultsService {
        ...
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{locations}/applicationGatewayWafDynamicManifests/dafault")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApplicationGatewayWafDynamicManifestResultInner>> get(@HostParam("$host") String endpoint,
            @PathParam("locations") String locations, @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<ApplicationGatewayWafDynamicManifestResultInner>> getWithResponseAsync(String locations) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), locations, apiVersion,
    ...
    private Mono<Response<ApplicationGatewayWafDynamicManifestResultInner>> getWithResponseAsync(String locations,
        ...
        return service.get(this.client.getEndpoint(), locations, apiVersion, this.client.getSubscriptionId(), accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApplicationGatewayWafDynamicManifestResultInner> getAsync(String locations) {
        return getWithResponseAsync(locations).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApplicationGatewayWafDynamicManifestResultInner> getWithResponse(String locations,
        Context context) {
        return getWithResponseAsync(locations, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApplicationGatewayWafDynamicManifestResultInner get(String locations) {
        return getWithResponse(locations, Context.NONE).getValue();
    }
}
