...
import com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.CreateOrUpdateComputePolicyParameters;
import com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.ErrorResponseException;
import com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.UpdateComputePolicyParameters;
...
public class ComputePoliciesInner {
    ...
    interface ComputePoliciesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.ComputePolicies listByAccount" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.ComputePolicies createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.ComputePolicies get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.ComputePolicies update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.ComputePolicies delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.ComputePolicies listByAccountNext" })
        @GET
    ...
    private ServiceResponse<PageImpl<ComputePolicyInner>> listByAccountDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<ComputePolicyInner>, ErrorResponseException>newInstance(this.client.serializerAdapter())
    ...
    private ServiceResponse<ComputePolicyInner> createOrUpdateDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ComputePolicyInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
    ...
    private ServiceResponse<ComputePolicyInner> getDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ComputePolicyInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<ComputePolicyInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
    ...
    private ServiceResponse<ComputePolicyInner> updateDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ComputePolicyInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<ComputePolicyInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
    ...
    private ServiceResponse<PageImpl<ComputePolicyInner>> listByAccountNextDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<ComputePolicyInner>, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<ComputePolicyInner>>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
