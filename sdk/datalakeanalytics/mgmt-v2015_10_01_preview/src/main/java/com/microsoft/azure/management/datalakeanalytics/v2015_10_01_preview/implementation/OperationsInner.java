...
public class OperationsInner {
     ...
     */
    public OperationsInner(Retrofit retrofit, DataLakeAnalyticsAccountManagementClientImpl client) {
    ...
    interface OperationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalakeanalytics.v2015_10_01_preview.Operations list" })
    ...
    private ServiceResponse<OperationListResultInner> listDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<OperationListResultInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
