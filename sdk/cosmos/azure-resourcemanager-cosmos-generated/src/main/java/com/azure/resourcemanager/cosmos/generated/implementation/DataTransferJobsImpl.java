...
public final class DataTransferJobsImpl implements DataTransferJobs {
    ...
    public PagedIterable<DataTransferJobGetResults> listByDatabaseAccount(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DataTransferJobGetResultsImpl(inner1, this.manager()));
    }
    ...
    public DataTransferJobGetResults getById(String id) {
        ...
        String jobName = ResourceManagerUtils.getValueFromIdByName(id, "dataTransferJobs");
        if (jobName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
