...
public final class NotebookWorkspacesClientImpl implements NotebookWorkspacesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NotebookWorkspaceInner> getAsync(String resourceGroupName, String accountName,
        NotebookWorkspaceName notebookWorkspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NotebookWorkspaceConnectionInfoResultInner> listConnectionInfoAsync(String resourceGroupName,
        String accountName, NotebookWorkspaceName notebookWorkspaceName) {
