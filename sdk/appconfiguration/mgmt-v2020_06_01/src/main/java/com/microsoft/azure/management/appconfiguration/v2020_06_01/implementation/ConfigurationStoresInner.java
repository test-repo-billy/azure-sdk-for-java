...
public class ConfigurationStoresInner implements InnerSupportsGet<ConfigurationStoreInner>, InnerSupportsDelete<Void>, InnerSupportsListing<ConfigurationStoreInner> {
    ...
    interface ConfigurationStoresService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.appconfiguration.v2020_06_01.ConfigurationStores creatdadADSVe" })
        ...
        Observable<Response<ResponseBody>> creatdadADSVe(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("configStoreName") String configStoreName, @Query("api-version") String apiVersion, @Body ConfigurationStoreInner configStoreCreationParameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.appconfiguration.v2020_06_01.ConfigurationStores beginCreatdadADSVe" })
        @PUT("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}")
        Observable<Response<ResponseBody>> beginCreatdadADSVe(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("configStoreName") String configStoreName, @Query("api-version") String apiVersion, @Body ConfigurationStoreInner configStoreCreationParameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     * @return the ConfigurationStoreInner object if successful.
     */
    public ConfigurationStoreInner creatdadADSVe(String resourceGroupName, String configStoreName, ConfigurationStoreInner configStoreCreationParameters) {
        return creatdadADSVeWithServiceResponseAsync(resourceGroupName, configStoreName, configStoreCreationParameters).toBlocking().last().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ConfigurationStoreInner> creatdadADSVeAsync(String resourceGroupName, String configStoreName, ConfigurationStoreInner configStoreCreationParameters, final ServiceCallback<ConfigurationStoreInner> serviceCallback) {
        return ServiceFuture.fromResponse(creatdadADSVeWithServiceResponseAsync(resourceGroupName, configStoreName, configStoreCreationParameters), serviceCallback);
    }
     ...
     */
    public Observable<ConfigurationStoreInner> creatdadADSVeAsync(String resourceGroupName, String configStoreName, ConfigurationStoreInner configStoreCreationParameters) {
        return creatdadADSVeWithServiceResponseAsync(resourceGroupName, configStoreName, configStoreCreationParameters).map(new Func1<ServiceResponse<ConfigurationStoreInner>, ConfigurationStoreInner>() {
            @Override
            public ConfigurationStoreInner call(ServiceResponse<ConfigurationStoreInner> response) {
                return response.body();
            }
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponse<ConfigurationStoreInner>> creatdadADSVeWithServiceResponseAsync(String resourceGroupName, String configStoreName, ConfigurationStoreInner configStoreCreationParameters) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        Observable<Response<ResponseBody>> observable = service.creatdadADSVe(this.client.subscriptionId(), resourceGroupName, configStoreName, this.client.apiVersion(), configStoreCreationParameters, this.client.acceptLanguage(), this.client.userAgent());
     ...
     * @return the ConfigurationStoreInner object if successful.
     */
    public ConfigurationStoreInner beginCreatdadADSVe(String resourceGroupName, String configStoreName, ConfigurationStoreInner configStoreCreationParameters) {
        return beginCreatdadADSVeWithServiceResponseAsync(resourceGroupName, configStoreName, configStoreCreationParameters).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ConfigurationStoreInner> beginCreatdadADSVeAsync(String resourceGroupName, String configStoreName, ConfigurationStoreInner configStoreCreationParameters, final ServiceCallback<ConfigurationStoreInner> serviceCallback) {
        return ServiceFuture.fromResponse(beginCreatdadADSVeWithServiceResponseAsync(resourceGroupName, configStoreName, configStoreCreationParameters), serviceCallback);
    }
     ...
     * @return the observable to the ConfigurationStoreInner object
     */
    public Observable<ConfigurationStoreInner> beginCreatdadADSVeAsync(String resourceGroupName, String configStoreName, ConfigurationStoreInner configStoreCreationParameters) {
        return beginCreatdadADSVeWithServiceResponseAsync(resourceGroupName, configStoreName, configStoreCreationParameters).map(new Func1<ServiceResponse<ConfigurationStoreInner>, ConfigurationStoreInner>() {
            @Override
            public ConfigurationStoreInner call(ServiceResponse<ConfigurationStoreInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ConfigurationStoreInner object
     */
    public Observable<ServiceResponse<ConfigurationStoreInner>> beginCreatdadADSVeWithServiceResponseAsync(String resourceGroupName, String configStoreName, ConfigurationStoreInner configStoreCreationParameters) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        Validator.validate(configStoreCreationParameters);
        return service.beginCreatdadADSVe(this.client.subscriptionId(), resourceGroupName, configStoreName, this.client.apiVersion(), configStoreCreationParameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ConfigurationStoreInner>>>() {
                @Override
                public Observable<ServiceResponse<ConfigurationStoreInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<ConfigurationStoreInner> clientResponse = beginCreatdadADSVeDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<ConfigurationStoreInner> beginCreatdadADSVeDelegate(Response<ResponseBody> response) throws ErrorException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ConfigurationStoreInner, ErrorException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<ConfigurationStoreInner>() { }.getType())
