...
public final class ReplicaImpl implements Replica, Replica.Definition {
    ...
    public Replica create() {
        this.innerObject = serviceManager.serviceClient().getReplicas().create(resourceGroupName, configStoreName,
    ...
    public Replica refresh() {
        this.innerObject = serviceManager.serviceClient().getReplicas()
            .getWithResponse(resourceGroupName, configStoreName, replicaName, Context.NONE).getValue();
        return this;
    }

    public Replica refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getReplicas()
            .getWithResponse(resourceGroupName, configStoreName, replicaName, context).getValue();
        return this;
    }
