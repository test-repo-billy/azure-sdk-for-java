...
public final class ManagedServerDnsAliasAcquisition {
    ...
    /**
     * Get the oldManagedServerDnsAliasResourceId property: The resource ID of the managed server DNS alias that will
     * be acquired to point to this managed server instead.
     * 
    ...
    /**
     * Set the oldManagedServerDnsAliasResourceId property: The resource ID of the managed server DNS alias that will
     * be acquired to point to this managed server instead.
     * 
