    ...
    public void validate() {
        if (startDay() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property startDay in model ScheduleItem"));
        }
        if (startTime() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property startTime in model ScheduleItem"));
        }
        if (stopDay() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property stopDay in model ScheduleItem"));
        }
        if (stopTime() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property stopTime in model ScheduleItem"));
        }
    }
