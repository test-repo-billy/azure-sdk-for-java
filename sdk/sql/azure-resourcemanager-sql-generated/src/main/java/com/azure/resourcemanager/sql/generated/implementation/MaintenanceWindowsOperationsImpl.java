...
public final class MaintenanceWindowsOperationsImpl implements MaintenanceWindowsOperations {
    ...
    public MaintenanceWindowsOperationsImpl(MaintenanceWindowsOperationsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<MaintenanceWindows> getWithResponse(String resourceGroupName, String serverName,
        String databaseName, String maintenanceWindowName, Context context) {
        Response<MaintenanceWindowsInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serverName,
            databaseName, maintenanceWindowName, context);
        if (inner != null) {
    ...
    public MaintenanceWindows get(String resourceGroupName, String serverName, String databaseName,
    ...
    public Response<Void> createOrUpdateWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        return this.serviceClient().createOrUpdateWithResponse(resourceGroupName, serverName, databaseName,
    ...
    public void createOrUpdate(String resourceGroupName, String serverName, String databaseName,
        ...
        this.serviceClient().createOrUpdate(resourceGroupName, serverName, databaseName, maintenanceWindowName,
            parameters);
    }
