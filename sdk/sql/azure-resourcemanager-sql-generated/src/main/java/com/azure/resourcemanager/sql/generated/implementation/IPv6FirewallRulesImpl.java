...
public final class IPv6FirewallRulesImpl implements IPv6FirewallRules {
    ...
    public IPv6FirewallRulesImpl(IPv6FirewallRulesClient innerClient,
    ...
    public Response<IPv6FirewallRule> getWithResponse(String resourceGroupName, String serverName,
    ...
    public IPv6FirewallRule getById(String id) {
        ...
        if (firewallRuleName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'ipv6FirewallRules'.", id)));
        }
