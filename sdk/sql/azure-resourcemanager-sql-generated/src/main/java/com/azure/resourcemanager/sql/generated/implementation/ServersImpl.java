...
public final class ServersImpl implements Servers {
    ...
    public Response<Server> getByResourceGroupWithResponse(String resourceGroupName, String serverName, String expand,
        Context context) {
    ...
    public ImportExportOperationResult importDatabase(String resourceGroupName, String serverName,
    ...
    public RefreshExternalGovernanceStatusOperationResult refreshStatus(String resourceGroupName, String serverName) {
        RefreshExternalGovernanceStatusOperationResultInner inner
            = this.serviceClient().refreshStatus(resourceGroupName, serverName);
        if (inner != null) {
            return new RefreshExternalGovernanceStatusOperationResultImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public RefreshExternalGovernanceStatusOperationResult refreshStatus(String resourceGroupName, String serverName,
        Context context) {
        RefreshExternalGovernanceStatusOperationResultInner inner
            = this.serviceClient().refreshStatus(resourceGroupName, serverName, context);
        if (inner != null) {
            return new RefreshExternalGovernanceStatusOperationResultImpl(inner, this.manager());
        } else {
            return null;
