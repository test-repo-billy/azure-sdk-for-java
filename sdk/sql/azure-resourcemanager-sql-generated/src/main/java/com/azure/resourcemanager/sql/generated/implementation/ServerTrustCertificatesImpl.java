...
public final class ServerTrustCertificatesImpl implements ServerTrustCertificates {
    ...
    public ServerTrustCertificatesImpl(ServerTrustCertificatesClient innerClient,
    ...
    public Response<ServerTrustCertificate> getWithResponse(String resourceGroupName, String managedInstanceName,
    ...
    public ServerTrustCertificate getById(String id) {
        ...
        if (certificateName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String
                .format("The resource ID '%s' is not valid. Missing path segment 'serverTrustCertificates'.", id)));
        }
