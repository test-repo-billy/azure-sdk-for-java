...
public final class SqlAgentsImpl implements SqlAgents {
    ...
    public SqlAgentsImpl(SqlAgentsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<SqlAgentConfiguration> getWithResponse(String resourceGroupName, String managedInstanceName,
        Context context) {
    ...
    public Response<SqlAgentConfiguration> createOrUpdateWithResponse(String resourceGroupName,
        String managedInstanceName, SqlAgentConfigurationInner parameters, Context context) {
        Response<SqlAgentConfigurationInner> inner = this.serviceClient().createOrUpdateWithResponse(resourceGroupName,
    ...
    public SqlAgentConfiguration createOrUpdate(String resourceGroupName, String managedInstanceName,
