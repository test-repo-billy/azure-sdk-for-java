...
public final class InstanceFailoverGroupInner extends ProxyResource {
    ...
    /**
     * Get the secondaryType property: Type of the geo-secondary instance. Set 'Standby' if the instance is used as a
     * DR option only.
     * 
    ...
    /**
     * Set the secondaryType property: Type of the geo-secondary instance. Set 'Standby' if the instance is used as a
     * DR option only.
     * 
