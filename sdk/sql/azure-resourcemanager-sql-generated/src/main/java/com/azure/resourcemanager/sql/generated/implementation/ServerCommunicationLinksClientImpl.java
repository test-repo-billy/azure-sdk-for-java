...
public final class ServerCommunicationLinksClientImpl implements ServerCommunicationLinksClient {
    ...
    public interface ServerCommunicationLinksService {
        ...
        Mono<Response<Void>> delete(@HostParam("$host") String endpoint, @QueryParam("api-version") String apiVersion,
            ...
            @PathParam("communicationLinkName") String communicationLinkName, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServerCommunicationLinkInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("communicationLinkName") String communicationLinkName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServerCommunicationLinkListResult>> listByServer(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, serverName, communicationLinkName, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String serverName,
        String communicationLinkName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.delete(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            serverName, communicationLinkName, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String resourceGroupName, String serverName, String communicationLinkName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ServerCommunicationLinkInner>> getWithResponseAsync(String resourceGroupName,
        String serverName, String communicationLinkName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                resourceGroupName, serverName, communicationLinkName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ServerCommunicationLinkInner>> getWithResponseAsync(String resourceGroupName,
        String serverName, String communicationLinkName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            serverName, communicationLinkName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerCommunicationLinkInner> getAsync(String resourceGroupName, String serverName,
        String communicationLinkName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ServerCommunicationLinkInner> getWithResponse(String resourceGroupName, String serverName,
        String communicationLinkName, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String serverName, String communicationLinkName, ServerCommunicationLinkInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, serverName, communicationLinkName, parameters,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String serverName, String communicationLinkName, ServerCommunicationLinkInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serverName, communicationLinkName, parameters, accept, context);
    }
    ...
    private PollerFlux<PollResult<ServerCommunicationLinkInner>, ServerCommunicationLinkInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<ServerCommunicationLinkInner, ServerCommunicationLinkInner>getLroResult(mono,
            this.client.getHttpPipeline(), ServerCommunicationLinkInner.class, ServerCommunicationLinkInner.class,
    ...
    private PollerFlux<PollResult<ServerCommunicationLinkInner>, ServerCommunicationLinkInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String serverName, String communicationLinkName,
        ServerCommunicationLinkInner parameters, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, serverName,
            communicationLinkName, parameters, context);
        return this.client.<ServerCommunicationLinkInner, ServerCommunicationLinkInner>getLroResult(mono,
            this.client.getHttpPipeline(), ServerCommunicationLinkInner.class, ServerCommunicationLinkInner.class,
            context);
    }
    ...
    public SyncPoller<PollResult<ServerCommunicationLinkInner>, ServerCommunicationLinkInner> beginCreateOrUpdate(
        String resourceGroupName, String serverName, String communicationLinkName,
        ServerCommunicationLinkInner parameters) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, serverName, communicationLinkName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ServerCommunicationLinkInner>, ServerCommunicationLinkInner> beginCreateOrUpdate(
        String resourceGroupName, String serverName, String communicationLinkName,
        ServerCommunicationLinkInner parameters, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, serverName, communicationLinkName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerCommunicationLinkInner> createOrUpdateAsync(String resourceGroupName, String serverName,
        String communicationLinkName, ServerCommunicationLinkInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, serverName, communicationLinkName, parameters).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerCommunicationLinkInner> createOrUpdateAsync(String resourceGroupName, String serverName,
        String communicationLinkName, ServerCommunicationLinkInner parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServerCommunicationLinkInner createOrUpdate(String resourceGroupName, String serverName,
        String communicationLinkName, ServerCommunicationLinkInner parameters) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of server communication links along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ServerCommunicationLinkInner>> listByServerSinglePageAsync(String resourceGroupName,
        String serverName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            ...
            .<PagedResponse<ServerCommunicationLinkInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
