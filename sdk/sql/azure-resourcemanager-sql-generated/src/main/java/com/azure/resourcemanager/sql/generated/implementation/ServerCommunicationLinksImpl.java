...
public final class ServerCommunicationLinksImpl implements ServerCommunicationLinks {
    ...
    public ServerCommunicationLinksImpl(ServerCommunicationLinksClient innerClient,
    ...
    public Response<ServerCommunicationLink> getWithResponse(String resourceGroupName, String serverName,
    ...
    public ServerCommunicationLink getById(String id) {
        ...
        if (communicationLinkName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'communicationLinks'.", id)));
        }
