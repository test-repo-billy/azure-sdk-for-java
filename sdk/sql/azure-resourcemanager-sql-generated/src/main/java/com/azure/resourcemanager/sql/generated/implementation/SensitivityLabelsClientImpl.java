...
public final class SensitivityLabelsClientImpl implements SensitivityLabelsClient {
    ...
    private Mono<PagedResponse<SensitivityLabelInner>> listCurrentByDatabaseSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.listCurrentByDatabase(this.client.getEndpoint(), resourceGroupName,
                serverName, databaseName, skipToken, count, filter, this.client.getSubscriptionId(), apiVersion, accept,
                context))
    ...
    private Mono<PagedResponse<SensitivityLabelInner>> listCurrentByDatabaseSinglePageAsync(String resourceGroupName,
        ...
        return service
            .listCurrentByDatabase(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, skipToken,
                count, filter, this.client.getSubscriptionId(), apiVersion, accept, context)
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return service.delete(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, schemaName,
            tableName, columnName, sensitivityLabelSource, this.client.getSubscriptionId(), apiVersion, context);
    }
