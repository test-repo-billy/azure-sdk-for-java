...
public final class MaintenanceWindowOptionsOperationsImpl implements MaintenanceWindowOptionsOperations {
    ...
    public MaintenanceWindowOptionsOperationsImpl(MaintenanceWindowOptionsOperationsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<MaintenanceWindowOptions> getWithResponse(String resourceGroupName, String serverName,
        ...
        Response<MaintenanceWindowOptionsInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            serverName, databaseName, maintenanceWindowOptionsName, context);
        if (inner != null) {
    ...
    public MaintenanceWindowOptions get(String resourceGroupName, String serverName, String databaseName,
