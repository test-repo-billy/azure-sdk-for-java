...
public final class SyncAgentsClientImpl implements SyncAgentsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, serverName,
                syncAgentName, this.client.getSubscriptionId(), apiVersion, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), resourceGroupName, serverName,
                syncAgentName, this.client.getSubscriptionId(), apiVersion, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<SyncAgentKeyPropertiesInner>> generateKeyWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.generateKey(this.client.getEndpoint(), resourceGroupName, serverName,
                syncAgentName, this.client.getSubscriptionId(), apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<PagedResponse<SyncAgentLinkedDatabaseInner>>
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listLinkedDatabases(this.client.getEndpoint(), resourceGroupName,
                serverName, syncAgentName, this.client.getSubscriptionId(), apiVersion, accept, context))
