 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type", defaultImpl = ClientCertAuthentication.class)
...
public class ClientCertAuthentication extends HttpAuthentication {
    ...
    /**
     * Get gets or sets the certificate password, return value will always be empty.
     *
    ...
    /**
     * Set gets or sets the certificate password, return value will always be empty.
     *
    ...
    /**
     * Get gets or sets the pfx certificate. Accepts certification in base64 encoding, return value will always be empty.
     *
    ...
    /**
     * Set gets or sets the pfx certificate. Accepts certification in base64 encoding, return value will always be empty.
     *
