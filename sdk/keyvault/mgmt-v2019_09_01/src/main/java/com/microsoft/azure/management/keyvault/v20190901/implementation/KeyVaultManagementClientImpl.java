...
import com.microsoft.azure.management.keyvault.v20190901.KeyVaultManagementClient;
import com.microsoft.azure.management.keyvault.v20190901.Operations;
...
public class KeyVaultManagementClientImpl extends AzureServiceClient implements KeyVaultManagementClient {
    ...
    public String userAgent() {
        return String.format("%s (%s, %s)", super.userAgent(), "KeyVaultManagementClient", "2019-09-01");
    }
}
