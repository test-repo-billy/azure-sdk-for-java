...
public final class ConfigurationNamesOperationListSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ConfigurationNamesList.json
     */
    /**
...
public final class ConnectorCreateDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ConnectorDryrunCreate.json
     */
    /**
    ...
    public static void connectorDryrunCreate(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.connectors().defineDryrun("dryrunName").withExistingLocation("00000000-0000-0000-0000-000000000000", "test-rg", "westus").withParameters(new CreateOrUpdateDryrunParameters().withTargetService(new AzureResource().withId("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.DocumentDb/databaseAccounts/test-acc/mongodbDatabases/test-db")).withAuthInfo(new SecretAuthInfo().withName("name").withSecretInfo(new ValueSecretInfo().withValue("secret")))).create();
    }
}
```
...
public final class ConnectorCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/PutConnector.json
     */
    /**
...
public final class ConnectorDeleteSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/DeleteConnector.json
     */
    /**
    ...
    public static void deleteConnector(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.connectors().delete("00000000-0000-0000-0000-000000000000", "test-rg", "westus", "connectorName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ConnectorDeleteDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ConnectorDryrunDelete.json
     */
    /**
    ...
    public static void connectorDryrunDelete(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.connectors().deleteDryrunWithResponse("00000000-0000-0000-0000-000000000000", "test-rg", "westus", "dryrunName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ConnectorGenerateConfigurationsSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/GenerateConfigurations.json
     */
    /**
    ...
    public static void generateConfiguration(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.connectors().generateConfigurationsWithResponse("00000000-0000-0000-0000-000000000000", "test-rg", "westus", "connectorName", new ConfigurationInfo().withCustomizedKeys(mapOf("ASL_DocumentDb_ConnectionString", "MyConnectionstring")), com.azure.core.util.Context.NONE);
    }
...
public final class ConnectorGetSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/Connectors.json
     */
    /**
    ...
    public static void connector(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.connectors().getWithResponse("00000000-0000-0000-0000-000000000000", "test-rg", "westus", "connectorName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ConnectorGetDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ConnectorDryrunGet.json
     */
    /**
    ...
    public static void connectorDryrunGet(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.connectors().getDryrunWithResponse("00000000-0000-0000-0000-000000000000", "test-rg", "westus", "dryrunName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ConnectorListSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ConnectorList.json
     */
    /**
    ...
    public static void connectorList(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.connectors().list("00000000-0000-0000-0000-000000000000", "test-rg", "westus", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ConnectorListDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ConnectorDryrunList.json
     */
    /**
    ...
    public static void connectorDryrunList(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.connectors().listDryrun("00000000-0000-0000-0000-000000000000", "test-rg", "westus", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ConnectorUpdateSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/PatchConnector.json
     */
    /**
    ...
    public static void patchConnector(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        LinkerResource resource = manager.connectors().getWithResponse("00000000-0000-0000-0000-000000000000", "test-rg", "westus", "connectorName", com.azure.core.util.Context.NONE).getValue();
...
public final class ConnectorUpdateDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ConnectorDryrunUpdate.json
     */
    /**
    ...
    public static void connectorDryrunUpdate(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        DryrunResource resource = manager.connectors().getDryrunWithResponse("00000000-0000-0000-0000-000000000000", "test-rg", "westus", "dryrunName", com.azure.core.util.Context.NONE).getValue();
        resource.update().withParameters(new CreateOrUpdateDryrunParameters().withTargetService(new AzureResource().withId("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.DocumentDb/databaseAccounts/test-acc/mongodbDatabases/test-db")).withAuthInfo(new SecretAuthInfo().withName("name").withSecretInfo(new ValueSecretInfo().withValue("secret")))).apply();
    }
}
```
...
public final class ConnectorValidateSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ValidateConnectorSuccess.json
     */
    /**
    ...
    public static void validateConnectorSuccess(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.connectors().validate("00000000-0000-0000-0000-000000000000", "test-rg", "westus", "connectorName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class LinkerCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/PutLinker.json
     */
    /**
...
public final class LinkerDeleteSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/DeleteLinker.json
     */
    /**
...
public final class LinkerGetSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/Linker.json
     */
    /**
     * Sample code: Linker.
     * 
...
public final class LinkerListSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/LinkerList.json
     */
    /**
...
public final class LinkerListConfigurationsSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/GetConfigurations.json
     */
    /**
...
public final class LinkerUpdateSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/PatchLinker.json
     */
    /**
    ...
    public static void patchLinker(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.linkers().update("subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.Web/sites/test-app", "linkName", new LinkerPatch().withTargetService(new AzureResource().withId("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.DocumentDb/databaseAccounts/test-acc/mongodbDatabases/test-db")).withAuthInfo(new ServicePrincipalSecretAuthInfo().withClientId("name").withPrincipalId("id").withSecret("fakeTokenPlaceholder")), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class LinkerValidateSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ValidateLinkerSuccess.json
     */
    /**
...
public final class LinkersOperationCreateDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/PutDryrun.json
     */
    /**
...
public final class LinkersOperationDeleteDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/DeleteDryrun.json
     */
    /**
    ...
    public static void deleteDryrun(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.linkersOperations().deleteDryrunWithResponse("subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.Web/sites/test-app", "dryrunName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class LinkersOperationGenerateConfigurationsSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/LinkerGenerateConfigurations.json
     */
    /**
     * Sample code: GenerateConfiguration.
     * 
     ...
     */
    public static void generateConfiguration(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.linkersOperations().generateConfigurationsWithResponse("subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.Web/sites/test-app", "linkName", new ConfigurationInfo().withCustomizedKeys(mapOf("ASL_DocumentDb_ConnectionString", "MyConnectionstring")), com.azure.core.util.Context.NONE);
    }
...
public final class LinkersOperationGetDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/GetDryrun.json
     */
    /**
    ...
    public static void getDryrun(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.linkersOperations().getDryrunWithResponse("subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.Web/sites/test-app", "dryrunName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class LinkersOperationListDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/ListDryrun.json
     */
    /**
    ...
    public static void listDryrun(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.linkersOperations().listDryrun("subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.Web/sites/test-app", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class LinkersOperationUpdateDryrunSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/PatchDryrun.json
     */
    /**
...
public final class OperationsListSamples {
    /*
     * x-ms-original-file: specification/servicelinker/resource-manager/Microsoft.ServiceLinker/preview/2023-11-01-preview/examples/OperationsList.json
     */
    /**
     * Sample code: GetConfiguration.
     * 
