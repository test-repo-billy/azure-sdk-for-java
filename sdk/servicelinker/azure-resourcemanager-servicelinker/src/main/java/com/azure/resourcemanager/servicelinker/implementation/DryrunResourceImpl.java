...
public final class DryrunResourceImpl implements DryrunResource, DryrunResource.Definition, DryrunResource.Update {
    ...
    public DryrunResource create() {
        this.innerObject = serviceManager.serviceClient().getConnectors().createDryrun(subscriptionId,
            resourceGroupName, location, dryrunName, this.innerModel(), Context.NONE);
        return this;
    }

    public DryrunResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnectors().createDryrun(subscriptionId,
            resourceGroupName, location, dryrunName, this.innerModel(), context);
        return this;
    }
    ...
    public DryrunResource apply() {
        this.innerObject = serviceManager.serviceClient().getConnectors().updateDryrun(subscriptionId,
            resourceGroupName, location, dryrunName, updateParameters, Context.NONE);
        return this;
    }

    public DryrunResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnectors().updateDryrun(subscriptionId,
            resourceGroupName, location, dryrunName, updateParameters, context);
        return this;
    }
    ...
    public DryrunResource refresh() {
        this.innerObject = serviceManager.serviceClient().getConnectors()
            .getDryrunWithResponse(subscriptionId, resourceGroupName, location, dryrunName, Context.NONE).getValue();
        return this;
    }

    public DryrunResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnectors()
            .getDryrunWithResponse(subscriptionId, resourceGroupName, location, dryrunName, context).getValue();
        return this;
    }
