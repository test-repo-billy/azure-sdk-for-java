...
public final class ResourceMetric {
    ...
    @Generated
    @JsonCreator
    public ResourceMetric(@JsonProperty(value = "resourceId") String resourceId,
        @JsonProperty(value = "metricNamespace") String metricNamespace, @JsonProperty(value = "name") String name,
