...
class BillingSubscriptionsImpl extends WrapperImpl<BillingSubscriptionsInner> implements BillingSubscriptions {
    ...
    @Override
    public Observable<BillingSubscriptionsListResult> listByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName) {
        BillingSubscriptionsInner client = this.inner();
    ...
    @Override
    public Observable<BillingSubscription> listByBillingAccountNameAsync(final String billingAccountName) {
        BillingSubscriptionsInner client = this.inner();
