...
public interface PartnerTransfers extends HasInner<PartnerTransfersInner> {
     ...
     */
    Observable<CustomerBillingAccountTransferDetails> getAsync(String billingAccountName, String customerName, String transferName);
     ...
     * @return the observable for the request
     */
    Completable cancelAsync(String billingAccountName, String customerName, String transferName);
     ...
     * @return the observable for the request
     */
    Observable<BillingProfileBillingAccountTransferDetails> initiateAsync(String billingAccountName, String customerName, InitiateTransferRequest parameters);
