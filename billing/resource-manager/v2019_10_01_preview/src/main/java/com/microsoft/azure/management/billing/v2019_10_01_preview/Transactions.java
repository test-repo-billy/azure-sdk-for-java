...
public interface Transactions extends HasInner<TransactionsInner> {
     ...
     */
    Observable<TransactionListResult> listByBillingProfileNameAsync(String billingAccountName, String billingProfileName, String startDate, String endDate);
     ...
     * @return the observable for the request
     */
    Observable<TransactionListResult> listByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String startDate, String endDate);
     ...
     * @return the observable for the request
     */
    Observable<Transaction> listByBillingAccountNameAsync(final String billingAccountName, final String startDate, final String endDate);
