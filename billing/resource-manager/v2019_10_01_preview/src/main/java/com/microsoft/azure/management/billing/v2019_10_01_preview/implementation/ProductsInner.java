...
public class ProductsInner {
    ...
    interface ProductsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.Products listByBillingAccountName" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.Products listByInvoiceSectionName" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.Products updateAutoRenewByBillingAccountName" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.Products updateAutoRenewByInvoiceSectionName" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.Products listByBillingAccountNameNext" })
        @GET
     ...
     */
    public PagedList<ProductInner> listByBillingAccountName(final String billingAccountName) {
        ServiceResponse<Page<ProductInner>> response = listByBillingAccountNameSinglePageAsync(billingAccountName).toBlocking().single();
     ...
     */
    public ServiceFuture<List<ProductInner>> listByBillingAccountNameAsync(final String billingAccountName, final ListOperationCallback<ProductInner> serviceCallback) {
     ...
     */
    public Observable<Page<ProductInner>> listByBillingAccountNameAsync(final String billingAccountName) {
     ...
     * @return the observable to the PagedList&lt;ProductInner&gt; object
     */
    public Observable<ServiceResponse<Page<ProductInner>>> listByBillingAccountNameWithServiceResponseAsync(final String billingAccountName) {
     ...
     */
    public Observable<ServiceResponse<Page<ProductInner>>> listByBillingAccountNameSinglePageAsync(final String billingAccountName) {
        ...
        return service.listByBillingAccountName(billingAccountName, this.client.apiVersion(), filter, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<ProductInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<ProductInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<ProductInner>> result = listByBillingAccountNameDelegate(response);
     ...
     * @return the PagedList&lt;ProductInner&gt; object if successful.
     */
    public PagedList<ProductInner> listByBillingAccountName(final String billingAccountName, final String filter) {
        ServiceResponse<Page<ProductInner>> response = listByBillingAccountNameSinglePageAsync(billingAccountName, filter).toBlocking().single();
        return new PagedList<ProductInner>(response.body()) {
            @Override
            public Page<ProductInner> nextPage(String nextPageLink) {
                return listByBillingAccountNameNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<ProductInner>> listByBillingAccountNameAsync(final String billingAccountName, final String filter, final ListOperationCallback<ProductInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;ProductInner&gt; object
     */
    public Observable<Page<ProductInner>> listByBillingAccountNameAsync(final String billingAccountName, final String filter) {
     ...
     * @return the observable to the PagedList&lt;ProductInner&gt; object
     */
    public Observable<ServiceResponse<Page<ProductInner>>> listByBillingAccountNameWithServiceResponseAsync(final String billingAccountName, final String filter) {
     ...
     * Lists products by billing account name.
     *
    ServiceResponse<PageImpl<ProductInner>> * @param billingAccountName billing Account Id.
    ServiceResponse<PageImpl<ProductInner>> * @param filter May be used to filter by product type. The filter supports 'eq', 'lt', 'gt', 'le', 'ge', and 'and'. It does not currently support 'ne', 'or', or 'not'. Tag filter is a key value pair string where key and value is separated by a colon (:).
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;ProductInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<ProductInner>>> listByBillingAccountNameSinglePageAsync(final String billingAccountName, final String filter) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (this.client.apiVersion() == null) {
    ...
    private ServiceResponse<PageImpl<ProductInner>> listByBillingAccountNameDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
     ...
     */
    public ProductsListResultInner listByInvoiceSectionName(String billingAccountName, String billingProfileName, String invoiceSectionName) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ProductsListResultInner> listByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, final ServiceCallback<ProductsListResultInner> serviceCallback) {
     ...
     */
    public Observable<ProductsListResultInner> listByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName) {
        return listByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName).map(new Func1<ServiceResponse<ProductsListResultInner>, ProductsListResultInner>() {
            @Override
     ...
     * @return the observable to the ProductsListResultInner object
     */
    public Observable<ServiceResponse<ProductsListResultInner>> listByInvoiceSectionNameWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceSectionName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        ...
        final String filter = null;
        return service.listByInvoiceSectionName(billingAccountName, billingProfileName, invoiceSectionName, this.client.apiVersion(), filter, this.client.acceptLanguage(), this.client.userAgent())
     ...
     * @return the ProductsListResultInner object if successful.
     */
    public ProductsListResultInner listByInvoiceSectionName(String billingAccountName, String billingProfileName, String invoiceSectionName, String filter) {
        return listByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, filter).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ProductsListResultInner> listByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String filter, final ServiceCallback<ProductsListResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(listByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, filter), serviceCallback);
    }
     ...
     * @return the observable to the ProductsListResultInner object
     */
    public Observable<ProductsListResultInner> listByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String filter) {
        return listByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, filter).map(new Func1<ServiceResponse<ProductsListResultInner>, ProductsListResultInner>() {
            @Override
            public ProductsListResultInner call(ServiceResponse<ProductsListResultInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ProductsListResultInner object
     */
    public Observable<ServiceResponse<ProductsListResultInner>> listByInvoiceSectionNameWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String filter) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
     ...
     */
    public UpdateAutoRenewOperationInner updateAutoRenewByBillingAccountName(String billingAccountName, String productName) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountNameAsync(String billingAccountName, String productName, final ServiceCallback<UpdateAutoRenewOperationInner> serviceCallback) {
     ...
     */
    public Observable<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountNameAsync(String billingAccountName, String productName) {
        return updateAutoRenewByBillingAccountNameWithServiceResponseAsync(billingAccountName, productName).map(new Func1<ServiceResponse<UpdateAutoRenewOperationInner>, UpdateAutoRenewOperationInner>() {
            @Override
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<ServiceResponse<UpdateAutoRenewOperationInner>> updateAutoRenewByBillingAccountNameWithServiceResponseAsync(String billingAccountName, String productName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (productName == null) {
        ...
        return service.updateAutoRenewByBillingAccountName(billingAccountName, productName, this.client.apiVersion(), this.client.acceptLanguage(), body, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<UpdateAutoRenewOperationInner>>>() {
                ...
                public Observable<ServiceResponse<UpdateAutoRenewOperationInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<UpdateAutoRenewOperationInner> clientResponse = updateAutoRenewByBillingAccountNameDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
     ...
     * @return the UpdateAutoRenewOperationInner object if successful.
     */
    public UpdateAutoRenewOperationInner updateAutoRenewByBillingAccountName(String billingAccountName, String productName, UpdateAutoRenew autoRenew) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountNameAsync(String billingAccountName, String productName, UpdateAutoRenew autoRenew, final ServiceCallback<UpdateAutoRenewOperationInner> serviceCallback) {
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountNameAsync(String billingAccountName, String productName, UpdateAutoRenew autoRenew) {
        return updateAutoRenewByBillingAccountNameWithServiceResponseAsync(billingAccountName, productName, autoRenew).map(new Func1<ServiceResponse<UpdateAutoRenewOperationInner>, UpdateAutoRenewOperationInner>() {
            @Override
            public UpdateAutoRenewOperationInner call(ServiceResponse<UpdateAutoRenewOperationInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<ServiceResponse<UpdateAutoRenewOperationInner>> updateAutoRenewByBillingAccountNameWithServiceResponseAsync(String billingAccountName, String productName, UpdateAutoRenew autoRenew) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (productName == null) {
    ...
    private ServiceResponse<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountNameDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
     ...
     * @return the UpdateAutoRenewOperationInner object if successful.
     */
    public UpdateAutoRenewOperationInner updateAutoRenewByInvoiceSectionName(String billingAccountName, String billingProfileName, String invoiceSectionName, String productName) {
        return updateAutoRenewByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, productName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<UpdateAutoRenewOperationInner> updateAutoRenewByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String productName, final ServiceCallback<UpdateAutoRenewOperationInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateAutoRenewByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, productName), serviceCallback);
    }
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<UpdateAutoRenewOperationInner> updateAutoRenewByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String productName) {
        return updateAutoRenewByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, productName).map(new Func1<ServiceResponse<UpdateAutoRenewOperationInner>, UpdateAutoRenewOperationInner>() {
            @Override
            public UpdateAutoRenewOperationInner call(ServiceResponse<UpdateAutoRenewOperationInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<ServiceResponse<UpdateAutoRenewOperationInner>> updateAutoRenewByInvoiceSectionNameWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String productName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        UpdateAutoRenewRequest body = new UpdateAutoRenewRequest();
        body.withAutoRenew(null);
        return service.updateAutoRenewByInvoiceSectionName(billingAccountName, billingProfileName, invoiceSectionName, productName, this.client.apiVersion(), this.client.acceptLanguage(), body, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<UpdateAutoRenewOperationInner>>>() {
                @Override
                public Observable<ServiceResponse<UpdateAutoRenewOperationInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<UpdateAutoRenewOperationInner> clientResponse = updateAutoRenewByInvoiceSectionNameDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
     ...
     * @return the UpdateAutoRenewOperationInner object if successful.
     */
    public UpdateAutoRenewOperationInner updateAutoRenewByInvoiceSectionName(String billingAccountName, String billingProfileName, String invoiceSectionName, String productName, UpdateAutoRenew autoRenew) {
        return updateAutoRenewByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, productName, autoRenew).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<UpdateAutoRenewOperationInner> updateAutoRenewByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String productName, UpdateAutoRenew autoRenew, final ServiceCallback<UpdateAutoRenewOperationInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateAutoRenewByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, productName, autoRenew), serviceCallback);
    }
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<UpdateAutoRenewOperationInner> updateAutoRenewByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String productName, UpdateAutoRenew autoRenew) {
        return updateAutoRenewByInvoiceSectionNameWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, productName, autoRenew).map(new Func1<ServiceResponse<UpdateAutoRenewOperationInner>, UpdateAutoRenewOperationInner>() {
            @Override
            public UpdateAutoRenewOperationInner call(ServiceResponse<UpdateAutoRenewOperationInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<ServiceResponse<UpdateAutoRenewOperationInner>> updateAutoRenewByInvoiceSectionNameWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String productName, UpdateAutoRenew autoRenew) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
    ...
    private ServiceResponse<UpdateAutoRenewOperationInner> updateAutoRenewByInvoiceSectionNameDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<UpdateAutoRenewOperationInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<UpdateAutoRenewOperationInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
     ...
     * @return the PagedList&lt;ProductInner&gt; object if successful.
     */
    public PagedList<ProductInner> listByBillingAccountNameNext(final String nextPageLink) {
        ServiceResponse<Page<ProductInner>> response = listByBillingAccountNameNextSinglePageAsync(nextPageLink).toBlocking().single();
        return new PagedList<ProductInner>(response.body()) {
            @Override
            public Page<ProductInner> nextPage(String nextPageLink) {
                return listByBillingAccountNameNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<ProductInner>> listByBillingAccountNameNextAsync(final String nextPageLink, final ServiceFuture<List<ProductInner>> serviceFuture, final ListOperationCallback<ProductInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;ProductInner&gt; object
     */
    public Observable<Page<ProductInner>> listByBillingAccountNameNextAsync(final String nextPageLink) {
     ...
     * @return the observable to the PagedList&lt;ProductInner&gt; object
     */
    public Observable<ServiceResponse<Page<ProductInner>>> listByBillingAccountNameNextWithServiceResponseAsync(final String nextPageLink) {
        return listByBillingAccountNameNextSinglePageAsync(nextPageLink)
            .concatMap(new Func1<ServiceResponse<Page<ProductInner>>, Observable<ServiceResponse<Page<ProductInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<ProductInner>>> call(ServiceResponse<Page<ProductInner>> page) {
     ...
     * @return the PagedList&lt;ProductInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<ProductInner>>> listByBillingAccountNameNextSinglePageAsync(final String nextPageLink) {
        if (nextPageLink == null) {
        ...
        return service.listByBillingAccountNameNext(nextUrl, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<ProductInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<ProductInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<ProductInner>> result = listByBillingAccountNameNextDelegate(response);
                        return Observable.just(new ServiceResponse<Page<ProductInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<ProductInner>> listByBillingAccountNameNextDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<ProductInner>, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<ProductInner>>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
