...
public class ProductsInner {
    ...
    interface ProductsService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.Products updateAutoRenewByBillingAccount" })
        @POST("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/products/{productName}/updateAutoRenew")
        Observable<Response<ResponseBody>> updateAutoRenewByBillingAccount(@Path("billingAccountName") String billingAccountName, @Path("productName") String productName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Body UpdateAutoRenewRequest body, @Header("User-Agent") String userAgent);
     ...
     */
    public UpdateAutoRenewOperationInner updateAutoRenewByBillingAccount(String billingAccountName, String productName) {
        return updateAutoRenewByBillingAccountWithServiceResponseAsync(billingAccountName, productName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountAsync(String billingAccountName, String productName, final ServiceCallback<UpdateAutoRenewOperationInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateAutoRenewByBillingAccountWithServiceResponseAsync(billingAccountName, productName), serviceCallback);
    }
     ...
     */
    public Observable<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountAsync(String billingAccountName, String productName) {
        return updateAutoRenewByBillingAccountWithServiceResponseAsync(billingAccountName, productName).map(new Func1<ServiceResponse<UpdateAutoRenewOperationInner>, UpdateAutoRenewOperationInner>() {
            @Override
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<ServiceResponse<UpdateAutoRenewOperationInner>> updateAutoRenewByBillingAccountWithServiceResponseAsync(String billingAccountName, String productName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (productName == null) {
        ...
        return service.updateAutoRenewByBillingAccount(billingAccountName, productName, this.client.apiVersion(), this.client.acceptLanguage(), body, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<UpdateAutoRenewOperationInner>>>() {
                ...
                public Observable<ServiceResponse<UpdateAutoRenewOperationInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<UpdateAutoRenewOperationInner> clientResponse = updateAutoRenewByBillingAccountDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
     ...
     * @return the UpdateAutoRenewOperationInner object if successful.
     */
    public UpdateAutoRenewOperationInner updateAutoRenewByBillingAccount(String billingAccountName, String productName, UpdateAutoRenew autoRenew) {
        return updateAutoRenewByBillingAccountWithServiceResponseAsync(billingAccountName, productName, autoRenew).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountAsync(String billingAccountName, String productName, UpdateAutoRenew autoRenew, final ServiceCallback<UpdateAutoRenewOperationInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateAutoRenewByBillingAccountWithServiceResponseAsync(billingAccountName, productName, autoRenew), serviceCallback);
    }
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountAsync(String billingAccountName, String productName, UpdateAutoRenew autoRenew) {
        return updateAutoRenewByBillingAccountWithServiceResponseAsync(billingAccountName, productName, autoRenew).map(new Func1<ServiceResponse<UpdateAutoRenewOperationInner>, UpdateAutoRenewOperationInner>() {
            @Override
            public UpdateAutoRenewOperationInner call(ServiceResponse<UpdateAutoRenewOperationInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the UpdateAutoRenewOperationInner object
     */
    public Observable<ServiceResponse<UpdateAutoRenewOperationInner>> updateAutoRenewByBillingAccountWithServiceResponseAsync(String billingAccountName, String productName, UpdateAutoRenew autoRenew) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (productName == null) {
    ...
    private ServiceResponse<UpdateAutoRenewOperationInner> updateAutoRenewByBillingAccountDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
