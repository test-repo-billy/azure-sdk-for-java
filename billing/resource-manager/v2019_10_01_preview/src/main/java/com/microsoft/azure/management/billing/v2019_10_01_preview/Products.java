...
public interface Products extends HasInner<ProductsInner> {
     ...
     */
    Observable<ProductsListResult> listByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName);
     ...
     * @return the observable for the request
     */
    Observable<UpdateAutoRenewOperation> updateAutoRenewByBillingAccountNameAsync(String billingAccountName, String productName);
     ...
     * @return the observable for the request
     */
    Observable<UpdateAutoRenewOperation> updateAutoRenewByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String productName);
     ...
     * @return the observable for the request
     */
    Observable<Product> listByBillingAccountNameAsync(final String billingAccountName);
