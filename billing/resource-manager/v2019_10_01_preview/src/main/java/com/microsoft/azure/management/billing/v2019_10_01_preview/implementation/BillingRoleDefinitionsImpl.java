...
class BillingRoleDefinitionsImpl extends WrapperImpl<BillingRoleDefinitionsInner> implements BillingRoleDefinitions {
    ...
    @Override
    public Observable<BillingRoleDefinition> getByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String billingRoleDefinitionName) {
        BillingRoleDefinitionsInner client = this.inner();
        return client.getByInvoiceSectionNameAsync(billingAccountName, billingProfileName, invoiceSectionName, billingRoleDefinitionName)
    ...
    @Override
    public Observable<BillingRoleDefinitionListResult> listByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName) {
        BillingRoleDefinitionsInner client = this.inner();
