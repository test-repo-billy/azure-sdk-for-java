...
class PoliciesImpl extends WrapperImpl<PoliciesInner> implements Policies {
    ...
    @Override
    public Observable<Policy> getByBillingProfileNameAsync(String billingAccountName, String billingProfileName) {
        PoliciesInner client = this.inner();
        return client.getByBillingProfileNameAsync(billingAccountName, billingProfileName)
