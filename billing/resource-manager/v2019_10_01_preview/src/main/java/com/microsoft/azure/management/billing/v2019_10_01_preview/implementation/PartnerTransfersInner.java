...
public class PartnerTransfersInner {
     ...
     */
    public TransferDetailsInner initiate(String billingAccountName, String customerName, InitiateTransferRequest parameters) {
     ...
     */
    public ServiceFuture<TransferDetailsInner> initiateAsync(String billingAccountName, String customerName, InitiateTransferRequest parameters, final ServiceCallback<TransferDetailsInner> serviceCallback) {
     ...
     */
    public Observable<TransferDetailsInner> initiateAsync(String billingAccountName, String customerName, InitiateTransferRequest parameters) {
        return initiateWithServiceResponseAsync(billingAccountName, customerName, parameters).map(new Func1<ServiceResponse<TransferDetailsInner>, TransferDetailsInner>() {
            @Override
     ...
     * @return the observable to the TransferDetailsInner object
     */
    public Observable<ServiceResponse<TransferDetailsInner>> initiateWithServiceResponseAsync(String billingAccountName, String customerName, InitiateTransferRequest parameters) {
     ...
     * @return the TransferDetailsInner object if successful.
     */
    public TransferDetailsInner get(String billingAccountName, String customerName, String transferName) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<TransferDetailsInner> getAsync(String billingAccountName, String customerName, String transferName, final ServiceCallback<TransferDetailsInner> serviceCallback) {
     ...
     * @return the observable to the TransferDetailsInner object
     */
    public Observable<TransferDetailsInner> getAsync(String billingAccountName, String customerName, String transferName) {
        return getWithServiceResponseAsync(billingAccountName, customerName, transferName).map(new Func1<ServiceResponse<TransferDetailsInner>, TransferDetailsInner>() {
            @Override
            public TransferDetailsInner call(ServiceResponse<TransferDetailsInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the TransferDetailsInner object
     */
    public Observable<ServiceResponse<TransferDetailsInner>> getWithServiceResponseAsync(String billingAccountName, String customerName, String transferName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (customerName == null) {
     ...
     * @return the TransferDetailsInner object if successful.
     */
    public TransferDetailsInner cancel(String billingAccountName, String customerName, String transferName) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<TransferDetailsInner> cancelAsync(String billingAccountName, String customerName, String transferName, final ServiceCallback<TransferDetailsInner> serviceCallback) {
     ...
     * @return the observable to the TransferDetailsInner object
     */
    public Observable<TransferDetailsInner> cancelAsync(String billingAccountName, String customerName, String transferName) {
        return cancelWithServiceResponseAsync(billingAccountName, customerName, transferName).map(new Func1<ServiceResponse<TransferDetailsInner>, TransferDetailsInner>() {
            @Override
            public TransferDetailsInner call(ServiceResponse<TransferDetailsInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the TransferDetailsInner object
     */
    public Observable<ServiceResponse<TransferDetailsInner>> cancelWithServiceResponseAsync(String billingAccountName, String customerName, String transferName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (customerName == null) {
