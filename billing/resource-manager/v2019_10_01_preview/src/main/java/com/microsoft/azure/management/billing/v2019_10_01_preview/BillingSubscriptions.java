...
public interface BillingSubscriptions extends HasInner<BillingSubscriptionsInner> {
     ...
     * @return the observable for the request
     */
    Observable<BillingSubscriptionsListResult> listByInvoiceSectionNameAsync(String billingAccountName, String billingProfileName, String invoiceSectionName);
     ...
     * @return the observable for the request
     */
    Observable<BillingSubscription> listByBillingAccountNameAsync(final String billingAccountName);
