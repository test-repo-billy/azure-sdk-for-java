...
class CustomerBillingAccountTransferDetailsModelImpl extends WrapperImpl<TransferDetailsInner> implements CustomerBillingAccountTransferDetailsModel {
    private final BillingManager manager;

    CustomerBillingAccountTransferDetailsModelImpl(TransferDetailsInner inner,  BillingManager manager) {
        super(inner);
