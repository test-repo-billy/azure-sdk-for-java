...
class CustomerBillingAccountTransferDetailsImpl extends WrapperImpl<TransferDetailsInner> implements CustomerBillingAccountTransferDetails {
    private final BillingManager manager;
    private String billingAccountName;
    private String customerName;
    private String transferName;

    CustomerBillingAccountTransferDetailsImpl(TransferDetailsInner inner,  BillingManager manager) {
        super(inner);
