...
class InvoiceSectionsImpl extends WrapperImpl<InvoiceSectionsInner> implements InvoiceSections {
    ...
    @Override
    public Observable<InvoiceSection> createAsync(String billingAccountName, String billingProfileName, String invoiceSectionName) {
        InvoiceSectionsInner client = this.inner();
        return client.createAsync(billingAccountName, billingProfileName, invoiceSectionName)
