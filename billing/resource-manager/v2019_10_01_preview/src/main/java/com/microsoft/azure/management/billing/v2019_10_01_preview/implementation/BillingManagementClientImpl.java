...
public class BillingManagementClientImpl extends AzureServiceClient {
    ...
    /**
     * Gets Version of the API to be used with the client request. The current version is 2019-10-01-preview.
     *
    ...
    /**
     * The PartnerTransfersTransfersInner object to access its operations.
     */
    private PartnerTransfersTransfersInner partnerTransfersTransfers;

    /**
     * Gets the PartnerTransfersTransfersInner object to access its operations.
     * @return the PartnerTransfersTransfersInner object.
     */
    public PartnerTransfersTransfersInner partnerTransfersTransfers() {
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "BillingManagementClient", "2019-10-01-preview");
    }
}
