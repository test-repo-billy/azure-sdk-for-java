...
public class MicrosoftResourceHealthImpl extends AzureServiceClient {
    ...
    /**
     * Gets setting view=full expands the article parameters.
     *
    ...
    /**
     * Sets setting view=full expands the article parameters.
     *
     * @param view the view value.
     * @return the service client itself
     */
    public MicrosoftResourceHealthImpl withView(String view) {
        this.view = view;
        return this;
    }
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "MicrosoftResourceHealth", "2018-07-01-preview");
    }
}
