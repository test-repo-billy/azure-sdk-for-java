...
class ServerAzureADAdministratorsImpl extends WrapperImpl<ServerAzureADAdministratorsInner> implements ServerAzureADAdministrators {
    ...
    private Observable<ServerAzureADAdministratorInner> getServerAzureADAdministratorInnerUsingServerAzureADAdministratorsInnerAsync(String id) {
        ...
        String administratorName = IdParsingUtils.getValueFromIdByName(id, "administrators");
        ServerAzureADAdministratorsInner client = this.inner();
        return client.getAsync(resourceGroupName, serverName, administratorName);
    }

    @Override
    public Observable<ServerAzureADAdministrator> getAsync(String resourceGroupName, String serverName, String administratorName) {
        ServerAzureADAdministratorsInner client = this.inner();
        return client.getAsync(resourceGroupName, serverName, administratorName)
    ...
    @Override
    public Completable deleteAsync(String resourceGroupName, String serverName, String administratorName) {
        ServerAzureADAdministratorsInner client = this.inner();
        return client.deleteAsync(resourceGroupName, serverName, administratorName).toCompletable();
    }
