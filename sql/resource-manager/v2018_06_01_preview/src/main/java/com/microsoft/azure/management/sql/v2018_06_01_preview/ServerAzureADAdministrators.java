...
public interface ServerAzureADAdministrators {
     ...
     */
    Observable<ServerAzureADAdministrator> getAsync(String resourceGroupName, String serverName, String administratorName);
     ...
     * @return the observable for the request
     */
    Completable deleteAsync(String resourceGroupName, String serverName, String administratorName);
