...
public class PolicyAssignmentInner extends ProxyResource {
    ...
    /**
     * The policy assignment enforcement mode. Possible values are
     * NotSpecified, Default, and DoNotEnforce. Possible values include:
     * 'NotSpecified', 'Default', 'DoNotEnforce'.
     */
    ...
    /**
     * Get the policy assignment enforcement mode. Possible values are NotSpecified, Default, and DoNotEnforce. Possible values include: 'NotSpecified', 'Default', 'DoNotEnforce'.
     *
    ...
    /**
     * Set the policy assignment enforcement mode. Possible values are NotSpecified, Default, and DoNotEnforce. Possible values include: 'NotSpecified', 'Default', 'DoNotEnforce'.
     *
