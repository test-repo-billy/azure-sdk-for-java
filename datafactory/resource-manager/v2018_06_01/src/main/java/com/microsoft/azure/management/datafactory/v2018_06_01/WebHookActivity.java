...
public class WebHookActivity extends ControlActivity {
     ...
     * setting statusCode &gt;= 400 in callback request.
     */
    @JsonProperty(value = "typeProperties.reportStatusOnCallBack")
    private Boolean reportStatusOnCallBack;
    ...
    /**
     * Get when set to true, statusCode, output and error in callback request body will be consumed by activity. The activity can be marked as failed by setting statusCode &gt;= 400 in callback request.
     *
     * @return the reportStatusOnCallBack value
     */
    public Boolean reportStatusOnCallBack() {
        return this.reportStatusOnCallBack;
    }

    /**
     * Set when set to true, statusCode, output and error in callback request body will be consumed by activity. The activity can be marked as failed by setting statusCode &gt;= 400 in callback request.
     *
     * @param reportStatusOnCallBack the reportStatusOnCallBack value to set
     * @return the WebHookActivity object itself.
     */
    public WebHookActivity withReportStatusOnCallBack(Boolean reportStatusOnCallBack) {
