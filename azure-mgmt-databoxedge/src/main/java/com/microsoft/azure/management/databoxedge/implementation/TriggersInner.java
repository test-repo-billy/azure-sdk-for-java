...
public class TriggersInner {
    ...
    interface TriggersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.databoxedge.Triggers listByDataBoxEdgeDevice" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.databoxedge.Triggers get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.databoxedge.Triggers createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.databoxedge.Triggers beginCreateOrUpdate" })
        @PUT("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/triggers/{name}")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.databoxedge.Triggers delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.databoxedge.Triggers beginDelete" })
        @HTTP(path = "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/triggers/{name}", method = "DELETE", hasBody = true)
        Observable<Response<ResponseBody>> beginDelete(@Path("deviceName") String deviceName, @Path("name") String name, @Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.databoxedge.Triggers listByDataBoxEdgeDeviceNext" })
        @GET
    ...
    public Observable<ServiceResponse<Page<TriggerInner>>> listByDataBoxEdgeDeviceSinglePageAsync(final String deviceName, final String resourceGroupName) {
        ...
        return service.listByDataBoxEdgeDevice(deviceName, this.client.subscriptionId(), resourceGroupName, this.client.apiVersion(), expand, this.client.acceptLanguage(), this.client.userAgent())
     ...
     * @return the PagedList&lt;TriggerInner&gt; object if successful.
     */
    public PagedList<TriggerInner> listByDataBoxEdgeDevice(final String deviceName, final String resourceGroupName, final String expand) {
        ServiceResponse<Page<TriggerInner>> response = listByDataBoxEdgeDeviceSinglePageAsync(deviceName, resourceGroupName, expand).toBlocking().single();
        return new PagedList<TriggerInner>(response.body()) {
            @Override
            public Page<TriggerInner> nextPage(String nextPageLink) {
                return listByDataBoxEdgeDeviceNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<TriggerInner>> listByDataBoxEdgeDeviceAsync(final String deviceName, final String resourceGroupName, final String expand, final ListOperationCallback<TriggerInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByDataBoxEdgeDeviceSinglePageAsync(deviceName, resourceGroupName, expand),
            new Func1<String, Observable<ServiceResponse<Page<TriggerInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TriggerInner>>> call(String nextPageLink) {
                    return listByDataBoxEdgeDeviceNextSinglePageAsync(nextPageLink);
     ...
     * @return the observable to the PagedList&lt;TriggerInner&gt; object
     */
    public Observable<Page<TriggerInner>> listByDataBoxEdgeDeviceAsync(final String deviceName, final String resourceGroupName, final String expand) {
        return listByDataBoxEdgeDeviceWithServiceResponseAsync(deviceName, resourceGroupName, expand)
            .map(new Func1<ServiceResponse<Page<TriggerInner>>, Page<TriggerInner>>() {
                @Override
                public Page<TriggerInner> call(ServiceResponse<Page<TriggerInner>> response) {
                    return response.body();
    ...
    public Observable<ServiceResponse<Page<TriggerInner>>> listByDataBoxEdgeDeviceWithServiceResponseAsync(final String deviceName, final String resourceGroupName, final String expand) {
        return listByDataBoxEdgeDeviceSinglePageAsync(deviceName, resourceGroupName, expand)
            .concatMap(new Func1<ServiceResponse<Page<TriggerInner>>, Observable<ServiceResponse<Page<TriggerInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TriggerInner>>> call(ServiceResponse<Page<TriggerInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
    ...
    ServiceResponse<PageImpl<TriggerInner>> * @param expand Specify $filter='CustomContextTag eq &lt;tag&gt;' to filter on custom context tag property
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;TriggerInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<TriggerInner>>> listByDataBoxEdgeDeviceSinglePageAsync(final String deviceName, final String resourceGroupName, final String expand) {
        if (deviceName == null) {
            throw new IllegalArgumentException("Parameter deviceName is required and cannot be null.");
        }
        if (this.client.subscriptionId() == null) {
