...
import com.microsoft.azure.management.databoxedge.DataBoxEdgeDevice;
import com.microsoft.azure.Page;
import rx.Completable;
import com.microsoft.azure.management.databoxedge.DataBoxEdgeDeviceExtendedInfo;
import com.microsoft.azure.management.databoxedge.UpdateSummary;
import com.microsoft.azure.management.databoxedge.UploadCertificateResponse;
import com.microsoft.azure.management.databoxedge.UploadCertificateRequest;
import com.microsoft.azure.management.databoxedge.NetworkSettings;
import com.microsoft.azure.management.databoxedge.SecuritySettings;
...
class DevicesImpl extends WrapperImpl<DevicesInner> implements Devices {
    ...
    public Observable<DataBoxEdgeDevice> getByResourceGroupAsync(String resourceGroupName, String name) {
        return this.getDataBoxEdgeDeviceInnerUsingDevicesInnerAsync(resourceGroupName, name).map(new Func1<DataBoxEdgeDeviceInner, DataBoxEdgeDevice> () {
            @Override
