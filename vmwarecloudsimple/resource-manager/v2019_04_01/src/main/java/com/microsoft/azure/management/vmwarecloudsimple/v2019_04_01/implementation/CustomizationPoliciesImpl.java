...
class CustomizationPoliciesImpl extends WrapperImpl<CustomizationPoliciesInner> implements CustomizationPolicies {
    ...
    public Observable<CustomizationPolicy> getAsync(String regionId, String pcName, String customizationPolicyName) {
        ...
        .flatMap(new Func1<CustomizationPolicyInner, Observable<CustomizationPolicy>>() {
            @Override
            public Observable<CustomizationPolicy> call(CustomizationPolicyInner inner) {
                if (inner == null) {
                    return Observable.empty();
                } else {
                    return Observable.just((CustomizationPolicy)wrapModel(inner));
                }
            }
       });
    }
