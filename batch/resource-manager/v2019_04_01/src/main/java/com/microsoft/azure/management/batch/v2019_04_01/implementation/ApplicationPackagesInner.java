...
import com.microsoft.azure.management.batch.v2019_04_01.ActivateApplicationPackageParameters;
...
public class ApplicationPackagesInner {
    ...
    interface ApplicationPackagesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.batch.v2019_04_01.ApplicationPackages activate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.batch.v2019_04_01.ApplicationPackages create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.batch.v2019_04_01.ApplicationPackages delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.batch.v2019_04_01.ApplicationPackages get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.batch.v2019_04_01.ApplicationPackages list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.batch.v2019_04_01.ApplicationPackages listNext" })
        @GET
