...
public class FileSharesInner {
    ...
    interface FileSharesService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storage.v2019_04_01.FileShares listNext" })
        @GET
     ...
     * @return the PagedList&lt;FileShareItemInner&gt; object if successful.
     */
    public PagedList<FileShareItemInner> list(final String resourceGroupName, final String accountName, final String skipToken, final String maxpagesize, final String filter) {
        ServiceResponse<Page<FileShareItemInner>> response = listSinglePageAsync(resourceGroupName, accountName, skipToken, maxpagesize, filter).toBlocking().single();
        return new PagedList<FileShareItemInner>(response.body()) {
            @Override
            public Page<FileShareItemInner> nextPage(String nextPageLink) {
                return listNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<FileShareItemInner>> listAsync(final String resourceGroupName, final String accountName, final String skipToken, final String maxpagesize, final String filter, final ListOperationCallback<FileShareItemInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;FileShareItemInner&gt; object
     */
    public Observable<Page<FileShareItemInner>> listAsync(final String resourceGroupName, final String accountName, final String skipToken, final String maxpagesize, final String filter) {
     ...
     * @return the observable to the PagedList&lt;FileShareItemInner&gt; object
     */
    public Observable<ServiceResponse<Page<FileShareItemInner>>> listWithServiceResponseAsync(final String resourceGroupName, final String accountName, final String skipToken, final String maxpagesize, final String filter) {
    ...
    ServiceResponse<PageImpl1<FileShareItemInner>> * @param skipToken Optional. Continuation token for the list operation.
     ...
     * @return the PagedList&lt;FileShareItemInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<FileShareItemInner>>> listSinglePageAsync(final String resourceGroupName, final String accountName, final String skipToken, final String maxpagesize, final String filter) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (accountName == null) {
    ...
    private ServiceResponse<PageImpl1<FileShareItemInner>> listDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl1<FileShareItemInner>, ErrorResponseException>newInstance(this.client.serializerAdapter())
    ...
    private ServiceResponse<PageImpl1<FileShareItemInner>> listNextDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl1<FileShareItemInner>, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl1<FileShareItemInner>>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
