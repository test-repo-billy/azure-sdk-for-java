...
public class FileServicesInner {
    ...
    interface FileServicesService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storage.v2019_04_01.FileServices putServiceProperties" })
    ...
    private ServiceResponse<FileServiceItemsInner> listDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<FileServiceItemsInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
     ...
     */
    public FileServicePropertiesInner putServiceProperties(String resourceGroupName, String accountName) {
        return putServicePropertiesWithServiceResponseAsync(resourceGroupName, accountName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<FileServicePropertiesInner> putServicePropertiesAsync(String resourceGroupName, String accountName, final ServiceCallback<FileServicePropertiesInner> serviceCallback) {
        return ServiceFuture.fromResponse(putServicePropertiesWithServiceResponseAsync(resourceGroupName, accountName), serviceCallback);
    }
     ...
     */
    public Observable<FileServicePropertiesInner> putServicePropertiesAsync(String resourceGroupName, String accountName) {
        return putServicePropertiesWithServiceResponseAsync(resourceGroupName, accountName).map(new Func1<ServiceResponse<FileServicePropertiesInner>, FileServicePropertiesInner>() {
            @Override
     ...
     * @return the observable to the FileServicePropertiesInner object
     */
    public Observable<ServiceResponse<FileServicePropertiesInner>> putServicePropertiesWithServiceResponseAsync(String resourceGroupName, String accountName) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (accountName == null) {
        ...
        return service.putServiceProperties(resourceGroupName, accountName, this.client.subscriptionId(), fileServicesName, this.client.apiVersion(), this.client.acceptLanguage(), parameters, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<FileServicePropertiesInner>>>() {
                ...
                public Observable<ServiceResponse<FileServicePropertiesInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<FileServicePropertiesInner> clientResponse = putServicePropertiesDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
     ...
     * @return the FileServicePropertiesInner object if successful.
     */
    public FileServicePropertiesInner putServiceProperties(String resourceGroupName, String accountName, CorsRules cors) {
        return putServicePropertiesWithServiceResponseAsync(resourceGroupName, accountName, cors).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<FileServicePropertiesInner> putServicePropertiesAsync(String resourceGroupName, String accountName, CorsRules cors, final ServiceCallback<FileServicePropertiesInner> serviceCallback) {
        return ServiceFuture.fromResponse(putServicePropertiesWithServiceResponseAsync(resourceGroupName, accountName, cors), serviceCallback);
    }
     ...
     * @return the observable to the FileServicePropertiesInner object
     */
    public Observable<FileServicePropertiesInner> putServicePropertiesAsync(String resourceGroupName, String accountName, CorsRules cors) {
        return putServicePropertiesWithServiceResponseAsync(resourceGroupName, accountName, cors).map(new Func1<ServiceResponse<FileServicePropertiesInner>, FileServicePropertiesInner>() {
            @Override
            public FileServicePropertiesInner call(ServiceResponse<FileServicePropertiesInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the FileServicePropertiesInner object
     */
    public Observable<ServiceResponse<FileServicePropertiesInner>> putServicePropertiesWithServiceResponseAsync(String resourceGroupName, String accountName, CorsRules cors) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (accountName == null) {
    ...
    private ServiceResponse<FileServicePropertiesInner> putServicePropertiesDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<FileServicePropertiesInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
    ...
    private ServiceResponse<FileServicePropertiesInner> getServicePropertiesDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<FileServicePropertiesInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<FileServicePropertiesInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
